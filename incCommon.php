	...
	*/
	...
	function getTableList($skip_authentication = false) {
		...
		$arrTables = [
			...
			'persons' => ['Persons', '', 'table.gif', 'None'],
			'blasters' => ['Blasters', '', 'table.gif', 'None'],
			'landcruisers' => ['Landcruisers', '', 'table.gif', 'None'],
			'crimes' => ['Crimes', '', 'table.gif', 'None'],
		];
	...
	function get_sql_fields($table_name) {
		$sql_fields = [
			'persons' => "`persons`.`personal_id` as 'personal_id', `persons`.`homeworld` as 'homeworld', `persons`.`blaster_ownership` as 'blaster_ownership', `persons`.`landcruiser_ownership` as 'landcruiser_ownership'",
			'blasters' => "`blasters`.`manufacturer` as 'manufacturer', if(`blasters`.`date`,date_format(`blasters`.`date`,'%m/%d/%Y'),'') as 'date', `blasters`.`blaster_id` as 'blaster_id'",
			'landcruisers' => "`landcruisers`.`manufacturer` as 'manufacturer', if(`landcruisers`.`date`,date_format(`landcruisers`.`date`,'%m/%d/%Y'),'') as 'date', `landcruisers`.`landcruisers_id` as 'landcruisers_id'",
			'crimes' => "`crimes`.`type` as 'type', if(`crimes`.`date`,date_format(`crimes`.`date`,'%m/%d/%Y'),'') as 'date', `crimes`.`file_num` as 'file_num'",
		];
	...
	function htmlUserBar() {
		...
		<nav class="navbar navbar-default navbar-fixed-top hidden-print" role="navigation">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo PREPEND_PATH; ?>index.php"><i class="glyphicon glyphicon-home"></i> cspd</a>
			</div>
