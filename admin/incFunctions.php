...
########################################################################
	...
	function get_table_fields($tn = null) {
		...
		if($schema === null) {
			...
			$schema = [
				'persons' => [
					'personal_id' => ['appgini' => "VARCHAR(40) NOT NULL PRIMARY KEY"],
					'homeworld' => ['appgini' => "VARCHAR(40) NULL"],
					'blaster_ownership' => ['appgini' => "VARCHAR(40) NULL"],
					'landcruiser_ownership' => ['appgini' => "VARCHAR(40) NULL"],
				],
				'blasters' => [
					'manufacturer' => ['appgini' => "VARCHAR(40) NULL"],
					'date' => ['appgini' => "DATE NULL"],
					'blaster_id' => ['appgini' => "VARCHAR(40) NOT NULL PRIMARY KEY"],
				],
				'landcruisers' => [
					'manufacturer' => ['appgini' => "VARCHAR(40) NULL"],
					'date' => ['appgini' => "DATE NULL"],
					'landcruisers_id' => ['appgini' => "VARCHAR(40) NOT NULL PRIMARY KEY"],
				],
				'crimes' => [
					'type' => ['appgini' => "VARCHAR(40) NULL"],
					'date' => ['appgini' => "DATE NULL"],
					'file_num' => ['appgini' => "VARCHAR(40) NOT NULL PRIMARY KEY"],
				],
			];
		}
